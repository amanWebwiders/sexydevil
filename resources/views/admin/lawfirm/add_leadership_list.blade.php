                ...
                <form method="POST" action="javascript:void(0)" id="leadershipForm" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            ...
                            <input type="text" class="form-control" id="leadership_name" name="leadership_name">
                        </div>
                        
                        <div class="col-md-4 mb-4">
                            <label class="form-label">Email</label>
                            <input type="text" class="form-control" id="leadership_email" name="leadership_email">
                        </div>
                        ...
                        <div class="col-md-4 mb-4">
                           ...
                           <div class="d-flex">
                            ...
                            <input type="text" class="form-control" id="leadership_phone" name="leadership_phone">
                           </div>
                        </div>
                        
                        <div class="col-md-4 mb-4">
                            <label class="form-label">Fee</label>
                            <input type="text" class="form-control" id="leadership_fee" name="leadership_fee">
                        </div>
                        
                        <div class="col-md-4 mb-4">
                            <label class="form-label">Address</label>
                            <input type="text" class="form-control" id="leadership_address" name="leadership_address">
                        </div>
                        ...
                        <div class="col-md-12 mb-12">
                            ...
                            <textarea class="form-control" id="leadership_description" name="leadership_description" rows="4" cols="50"></textarea>
                        </div>
                       
                    </div>
                    <div class="text-end">
                         <button type="submit" class="btn ms-auto mt-3" name="addLeadership" id="addLeadership"><span id="profile_btn">Submit</span></button>
                    </div>
                </form>
            </div>
        </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key={{ env('GOOGLE_API_KEY') }}&libraries=places"></script>
 <script>
        $(document).ready(function() {
            initAutocomplete();
            $('#addLeadership').click(function(event){
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.save-leadershp') }}",
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    processData: false,
