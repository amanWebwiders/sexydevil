  ...
  <div class="reels-main-box">
    <div class="container-fluid">
      ...
      <div class="reels-card">
        @include('front.component.reelsAjax', ['allStories' => $allStories ?? $allUsers ?? []])
      </div>
      <div class="row">
...
@push('js')
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
      ...
      if (reelId) {
        const reelElement = document.getElementById(`reelsContainer-${reelId}`) || document.querySelector(`.profile-section[data-story-id="${reelId}"]`) || document.querySelector(`.reel[data-id="${reelId}"]`);
        if (reelElement) {
...
(function () {
    ...
    $(document).on('click', '.gallery-story-item', function (e) {
      ...
      if (userId && storyId) {
        $commentBtn.attr('href', '{{ url('/profile') }}/' + userId + '?tab=feeds&story_id=' + storyId);
      }
      var $shareBtn = $mediaContainer.find('.action-icons button[onclick^="shareReel"]');
      if ($shareBtn.length) {
